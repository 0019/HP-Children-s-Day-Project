...
function createMap() {
	for (var i = 0; i < coordinates.length; i++) {
		...
		newElement.setAttribute('cx', 150 + parseInt(loc[0]));
		newElement.setAttribute('cy', 170 + parseInt(loc[2]));
...
function relocate() {
	...
	switch(count) {
		...
		case 2: $('a-sky').attr('rotation', '0 -88 0'); break;
		case 3: $('a-sky').attr('rotation', '0 -90 0'); break;
		case 4: $('a-sky').attr('rotation', '0 -90 0'); break;
		case 5: $('a-sky').attr('rotation', '0 0 0'); break;
		case 6: $('a-sky').attr('rotation', '0 10 0'); break;
	}
